function optTheta_patch = learnFromPatches_4(patchDim,cubeDim,hiddenSize,patchNumber)
...
addpath /scratch/uceedua/DL3D/minFunc/
...
[optTheta_patch, cost] = minFunc( @(p) sparseAutoencoderCost(p, ...
