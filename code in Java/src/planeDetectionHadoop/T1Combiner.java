...
public class T1Combiner
  ...
  public void reduce(T1MapOutputKey key, Iterable<PointCloudWritable> values,
    ...
    System.out.println("-----------COMBINE WITH KEY" + i + "(" + key.hashCode()
        + ")" + ":" + key.getNormal().x + "," + key.getNormal().y + ","
        + key.getNormal().z + ";" + key.getPoint().z + "------------");
